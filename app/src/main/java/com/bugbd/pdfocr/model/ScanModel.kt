...
val scanItems = listOf(
    ScanItem(id = 0, icon = R.drawable.pdf,"Pdf Generate"),
    ScanItem(id = 1, icon = R.drawable.baseline_camera_24,"Document Capture"),
    ScanItem(id = 2,icon = R.drawable.ic_qr_scan_svg,"OCR"),
